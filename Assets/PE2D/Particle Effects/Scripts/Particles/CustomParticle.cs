...
namespace PE2D
{
	...
	public class CustomParticle : MonoBehaviour
	{
		...
		public MeshRenderer spriteRenderer { get { return _renderer; } }
		...
		private float? UpdateAlpha (float speed)
		{
			if (shouldUpdateAlpha) {
				...
				var colour = _renderer.material.color;
				_renderer.material.color = new Color (colour.r, colour.g, colour.b, ALPHA_MULTIPLIER * alpha);
